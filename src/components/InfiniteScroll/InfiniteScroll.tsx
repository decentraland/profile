...
export function InfiniteScroll({ page, hasMorePages, isLoading, maxScrollPages, onLoadMore, className }: Props) {
  ...
  return showLoadMoreButton ? (
    <div className={className}>
      <Button loading={isLoading} fluid inverted primary onClick={handleLoadMore}>
        {t('global.load_more')}
      </Button>
    </div>
  ) : null
