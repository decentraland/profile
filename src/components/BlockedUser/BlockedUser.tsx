...
const BlockedUser = (props: Props) => {
  ...
  return (
    <div className={classnames(styles.Blocked, isTabletAndBelow && styles.BlockedMobile)}>
      <Icon size="massive" name="ban" data-testid="ban" />
      <span className={classnames(styles.title, isTabletAndBelow && styles.titleMobile)}>
