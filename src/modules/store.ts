...
export function initStore() {
  ...
  const middleware = applyMiddleware(sagasMiddleware, loggerMiddleware, analyticsMiddleware)
  const composeEnhancers =
    isDev && (window as any).__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? (window as any).__REDUX_DEVTOOLS_EXTENSION_COMPOSE__() : compose
